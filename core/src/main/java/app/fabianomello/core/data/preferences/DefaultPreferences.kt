package app.fabianomello.core.data.preferences
...
class DefaultPreferences(
    ...
    override fun saveWeightGoal(goal: WeightGoal) {
        sharedPref.edit()
            .putString(Preferences.KEY_WEIGHT_GOAL, goal.name)
            .apply()
    }
    ...
    override fun loadUserInfo(): UserInfo {
        ...
        val weight = sharedPref.getFloat(Preferences.KEY_HEIGHT, -1f)
        ...
        val weightGoalString = sharedPref.getString(Preferences.KEY_WEIGHT_GOAL, null)
